...
<script id="Cookiebot" src="https://consent.cookiebot.com/uc.js" data-cbid="7ddab848-8cc9-4d60-9385-f4297558f760" data-blockingmode="auto" type="text/javascript"></script>
    ...
    <meta name="description" content="Convert images to text with our accurate, fast, and secure OCR tool.">

    <!-- Open Graph -->
    <meta property="og:title" content="File To Text – Free OCR for PDF & PPTX">
    <meta property="og:description"
          content="Extract text from your documents with high accuracy. Supports PDFs and PowerPoint files.">
    ...
    <meta name="twitter:title" content="File To Text – Free OCR for PDF & PPTX">
    <meta name="twitter:description"
          content="Extract text from your documents with high accuracy. Supports PDFs and PowerPoint files.">
    <meta name="twitter:image" content="https://filetotext.online/assets/og-image.png">


    <title>File to Text – Free Online OCR for PDF & PPTX</title>
...
<div class="max-w-3xl mx-auto px-4 py-8">
    ...
    <p class="mt-4">
        Your privacy is important to us. This Privacy Policy explains how we handle the information you provide through our file upload service.
    </p>

    <h2 class="text-xl font-semibold mt-6 mb-2">1. What We Collect</h2>
    <p>
        When you upload a file (PDF, PPTX, or image), we temporarily process that file to extract and display the text content to you.
    </p>

    <h2 class="text-xl font-semibold mt-6 mb-2">2. File and Data Handling</h2>
    <ul class="list-disc ml-6">
        <li>Uploaded files are stored temporarily during processing.</li>
        <li>After text is extracted and displayed, all uploaded files and extracted data are permanently deleted.</li>
        <li>No uploaded content is used for analytics, training, or shared with third parties.</li>
    </ul>

    <h2 class="text-xl font-semibold mt-6 mb-2">3. Cookies and Tracking</h2>
    <p>
        We only use cookies necessary for functionality. We do not use tracking or marketing cookies unless explicitly consented to. Please refer to our <a href="{{ route('privacy.policy') }}">Cookie Policy</a> for more.
    </p>

    <h2 class="text-xl font-semibold mt-6 mb-2">4. Your Rights (GDPR)</h2>
    <p>
        If you're in the EU, you have the right to access, correct, or request deletion of your personal data. Since we delete uploaded content automatically (within 10 minutes of user upload), there is usually no data retained. If you have any concerns, contact us.
    </p>

    <h2 class="text-xl font-semibold mt-6 mb-2">5. Contact</h2>
    <p>
        If you have questions about this policy, please contact us at: <a href="mailto:support@filetotext.online">support@filetotext.online</a>
    </p>
</div>
</body>
</html>
